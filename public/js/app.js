...
var Guild = function () {
    ...
    _createClass(Guild, null, [{
        ...
        key: 'get',
        value: function get(region, server, name) {
            return axios.get('/guilds/' + region + '/' + server + '/' + name);
        }
    }, {
        key: 'getBlizz',
        value: function getBlizz(region, server, name) {
        ...
        key: 'update',
        value: function update(region, server, name) {
...
/* harmony default export */ __webpack_exports__["a"] = Guild;
...
var moment = module.exports = __webpack_require__(148);
moment.tz.load(__webpack_require__(147));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__bootstrap__ = __webpack_require__(145);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__routes__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_GuildSearch_vue__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_GuildSearch_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_GuildSearch_vue__);
...
new Vue({
    ...
    components: { GuildSearch: __WEBPACK_IMPORTED_MODULE_2__components_GuildSearch_vue___default.a },

    methods: {
        childLoading: function childLoading(msg) {
            this.loading = true;
            this.error = false;
            this.loadingMessage = msg;
        },
        childLoaded: function childLoaded() {
            this.loading = false;
        },
        childError: function childError(msg) {
            this.error = true;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__models_Guild__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_Character__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_moment_timezone__ = __webpack_require__(11);
...
/* harmony default export */ __webpack_exports__["default"] = {
    props: ['headers', 'columns', 'characters', 'update', 'sortCol', 'sortDesc'],
    ...
    methods: {
        ...
        sort: function sort(colId) {
            this.$emit('sort', colId);
        },
        updateCharacter: function updateCharacter(char) {
            this.$emit('update', char);
        },
        updatedAt: function updatedAt(char) {
            if (char.updated_at) {
                return __WEBPACK_IMPORTED_MODULE_2_moment_timezone___default()(__WEBPACK_IMPORTED_MODULE_2_moment_timezone___default.a.tz(char.updated_at, 'UTC')).fromNow();
            } else {
                return 'Press Update!';
            }
        },
        disableUpdate: function disableUpdate(char) {
            return __WEBPACK_IMPORTED_MODULE_2_moment_timezone___default()().diff(__WEBPACK_IMPORTED_MODULE_2_moment_timezone___default()(__WEBPACK_IMPORTED_MODULE_2_moment_timezone___default.a.tz(char.updated_at, 'UTC')), 's') < 120;
        },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__models_Guild__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_Character__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__CharaterTable__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__CharaterTable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__CharaterTable__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = {
    data: function data() {
        return {
            ...
            views: {
                stats: {
                    headers: [{ cols: 3, name: 'Character Information' }, { cols: 11, name: 'Mythic Dungeons' }, { cols: 3, name: 'M+ In Time' }, { cols: 5, name: 'Raid Bosses Downed' }, { cols: 1, name: '' }, { cols: 3, name: 'Item Level' }, { cols: 2, name: 'Artifact' }],
                    columns: [{ id: 'name', name: 'Name' }, { id: 'class_name', name: 'Class', applyClass: true, class_name: 'class_name' }, { id: 'specc', name: 'Spec' }, { id: 'stats.kills.10880', name: 'EoA' }, { id: 'stats.kills.10883', name: 'DHT' }, { id: 'stats.kills.10886', name: 'NL' }, { id: 'stats.kills.10889', name: 'HoV' }, { id: 'stats.kills.10898', name: 'VotW' }, { id: 'stats.kills.10901', name: 'BRH' }, { id: 'stats.kills.10904', name: 'MoS' }, { id: 'stats.kills.10907', name: 'Arc' }, { id: 'stats.kills.10910', name: 'CoS' }, { id: 'stats.kills.11406', name: 'Kara' }, { id: 'stats.total_mythic_dungeons', name: 'Total' }, { id: 'stats.total_mythic_2', name: 'M+2' }, { id: 'stats.total_mythic_5', name: 'M+5' }, { id: 'stats.total_mythic_10', name: 'M+10' }, { id: 'stats.total_lfr_raid_bosses', name: 'LFR' }, { id: 'stats.total_normal_raid_bosses', name: 'Normal' }, { id: 'stats.total_heroic_raid_bosses', name: 'Heroic' }, { id: 'stats.total_mythic_raid_bosses', name: 'Mythic' }, { id: 'stats.total_raid_bosses', name: 'Total' }, { id: 'stats.total_wq', name: 'Total' }, { id: 'stats.equipped_ilvl', name: 'Eq ilvl' }, { id: 'stats.average_ilvl', name: 'Avg ilvl' }, { id: 'stats.artifact_ilvl', name: 'Art ilvl' }, { id: 'stats.total_ap', name: 'Total AP' }, { id: 'stats.highest_artifact_ilvl', name: 'Highest lvl' }]
                },
                rankings: {
                    headers: [{ cols: 3, name: 'Character Information' }, { cols: 3, name: 'Emerald Nightmare Average Rankings' }, { cols: 3, name: 'Trial of Valor Average Rankings' }, { cols: 3, name: 'Nighthold Average Rankings' }],
                    columns: [{ id: 'name', name: 'Name' }, { id: 'class_name', name: 'Class', applyClass: true, class_name: 'class_name' }, { id: 'specc', name: 'Spec' }, { id: 'average_rank_en_normal', name: 'Normal' }, { id: 'average_rank_en_heroic', name: 'Heroic' }, { id: 'average_rank_en_mythic', name: 'Mythic' }, { id: 'average_rank_tov_normal', name: 'Normal' }, { id: 'average_rank_tov_heroic', name: 'Heroic' }, { id: 'average_rank_tov_mythic', name: 'Mythic' }, { id: 'average_rank_nh_normal', name: 'Normal' }, { id: 'average_rank_nh_heroic', name: 'Heroic' }, { id: 'average_rank_nh_mythic', name: 'Mythic' }]
                }
            }
        };
    },
    ...
    components: {
        CharacterTable: __WEBPACK_IMPORTED_MODULE_2__CharaterTable___default.a
    },
    ...
    computed: {
        filteredMembers: function filteredMembers() {
            ...
            return this.guild.members.filter(function (member) {
                ...
                var valueA = _this.getPropByString(a, self.sortCol);
                var valueB = _this.getPropByString(b, self.sortCol);
                if (valueA == undefined) {
                    valueA = -1;
                }
    ...
    methods: {
        routeChanged: function routeChanged() {
            if (this.$route.params.guild !== this.guild.slug) {
                this.fetchGuild();
            }
            if (this.views[this.$route.params.view] !== undefined) {
                this.view = this.views[this.$route.params.view];
        ...
        fetchGuild: function fetchGuild() {
            var _this2 = this;

            this.hidden = true;
            this.$emit('loading', 'Checking cache for guild');
            __WEBPACK_IMPORTED_MODULE_0__models_Guild__["a" /* default */].get(this.$route.params.region, this.$route.params.server, this.$route.params.guild).then(this.loadedGuild).catch(function (error) {
                _this2.$emit('loading', 'Guild not in cache, fetching from blizzard');
                __WEBPACK_IMPORTED_MODULE_0__models_Guild__["a" /* default */].getBlizz(_this2.$route.params.region, _this2.$route.params.server, _this2.$route.params.guild).then(_this2.loadedGuild).catch(function (error) {
                    _this2.$emit('error', 'Guild not found.');
                    _this2.$emit('loaded');
                });
            });
        },
        loadedGuild: function loadedGuild(response) {
            var _this3 = this;

            response.data.members.forEach(function (c) {
                _this3.$set(c, 'update', {
                    updated: false,
                    updating: false,
                    message: 'Update'
        ...
        updateCharacter: function updateCharacter(char) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__models_Character__["a" /* default */].update(char.id).then(function (response) {
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__models_Guild__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_moment_timezone__ = __webpack_require__(11);
...
/* harmony default export */ __webpack_exports__["default"] = {
    ...
    methods: {
        fetchGuilds: function fetchGuilds() {
            var _this = this;

            this.$emit('loading');
            __WEBPACK_IMPORTED_MODULE_0__models_Guild__["a" /* default */].all().then(function (response) {
                response.data.data.forEach(function (g) {
                    g.updateDisabled = true;
                    g.updating = false;
                    g.message = 'Update';
                });
                _this.guilds = response.data.data; // Paginator, which is why it is data.data
                _this.$emit('loaded');
            }).catch(function (error) {
                _this.$emit('error');
            });
        },
        updateGuild: function updateGuild(guild) {
            guild.updating = true;
            __WEBPACK_IMPORTED_MODULE_0__models_Guild__["a" /* default */].update(guild.server.region.short, guild.server.name.toLowerCase(), guild.slug).then(function (response) {
        ...
        updatedAt: function updatedAt(guild) {
            return __WEBPACK_IMPORTED_MODULE_1_moment_timezone___default()(__WEBPACK_IMPORTED_MODULE_1_moment_timezone___default.a.tz(guild.updated_at, 'UTC')).fromNow();
        }
    }
};
...
__vue_options__.__file = "c:\\Symfony_Projects\\lucky\\resources\\assets\\js\\components\\CharaterTable.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c60a87c4", __vue_options__)
  } else {
    hotAPI.reload("data-v-c60a87c4", __vue_options__)
  }
})()}
if (__vue_options__.functional) {console.error("[vue-loader] CharaterTable.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
__vue_options__.__file = "c:\\Symfony_Projects\\lucky\\resources\\assets\\js\\components\\Guild.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-bd81c8ce", __vue_options__)
  } else {
    hotAPI.reload("data-v-bd81c8ce", __vue_options__)
  }
})()}
if (__vue_options__.functional) {console.error("[vue-loader] Guild.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
__vue_options__.__file = "c:\\Symfony_Projects\\lucky\\resources\\assets\\js\\components\\GuildSearch.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-12c3c4a1", __vue_options__)
  } else {
    hotAPI.reload("data-v-12c3c4a1", __vue_options__)
  }
})()}
if (__vue_options__.functional) {console.error("[vue-loader] GuildSearch.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
__vue_options__.__file = "c:\\Symfony_Projects\\lucky\\resources\\assets\\js\\components\\GuildTable.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-074086e5", __vue_options__)
  } else {
    hotAPI.reload("data-v-074086e5", __vue_options__)
  }
})()}
if (__vue_options__.functional) {console.error("[vue-loader] GuildTable.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('table', {
    staticClass: "guild-list-table"
  }, [_vm._m(0), _vm._v(" "), _vm._m(1), _vm._v(" "), _c('tbody', _vm._l((_vm.guilds), function(guild) {
    ...
    }, [_vm._v(_vm._s(guild.name))])], 1), _vm._v(" "), _c('td', [_vm._v(_vm._s(guild.server.region.name))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(guild.server.name))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(guild.members_count))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.updatedAt(guild)))]), _vm._v(" "), _c('td', [_c('button', {
      staticClass: "btn btn-default btn-xs float-right",
      on: {
        "click": function($event) {
          _vm.updateGuild(guild)
        }
      }
    }, [_c('i', {
      staticClass: "fa fa-refresh",
      class: {
        'fa-spin': guild.updating
      },
      attrs: {
        "title": "Update Guild"
      }
    }), _vm._v(" " + _vm._s(guild.message) + "\n                ")])])])
  }))])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('colgroup', [_c('col', {
    staticClass: "guild-name"
  }), _vm._v(" "), _c('col', {
    staticClass: "guild-info",
    attrs: {
      "span": "4"
    }
  })])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('thead', [_c('tr', [_c('th', [_vm._v("Name")]), _vm._v(" "), _c('th', [_vm._v("Region")]), _vm._v(" "), _c('th', [_vm._v("Server")]), _vm._v(" "), _c('th', [_vm._v("Members @ 110")]), _vm._v(" "), _c('th', [_vm._v("Last Updated")]), _vm._v(" "), _c('th', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-074086e5", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    directives: [{
      ...
      rawName: "v-model",
      value: (_vm.guildName),
      expression: "guildName"
    }],
    staticClass: "form-control",
    attrs: {
      "type": "text",
      "id": "guild-search-name",
      "placeholder": "Guild Name"
    },
    domProps: {
      "value": _vm._s(_vm.guildName)
    },
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.guildName = $event.target.value
      }
    }
  })]), _vm._v(" "), _c('div', {
    ...
    staticClass: "form-control",
    attrs: {
      "id": "guild-search-region"
    },
    on: {
      "change": function($event) {
        _vm.regionSelected = Array.prototype.filter.call($event.target.options, function(o) {
          return o.selected
        }).map(function(o) {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.serverSelected),
      expression: "serverSelected"
    }],
    staticClass: "form-control",
    attrs: {
      "id": "guild-search-server"
    },
    on: {
      "change": function($event) {
        _vm.serverSelected = Array.prototype.filter.call($event.target.options, function(o) {
          return o.selected
        }).map(function(o) {
          var val = "_value" in o ? o._value : o.value;
          return val
  ...
  }, _vm._l((_vm.regionSelected.servers), function(server) {
    return _c('option', {
      domProps: {
        "value": server
      }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-12c3c4a1", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (!_vm.hidden) ? _c('div', [_c('div', {
    staticClass: "character-list-input"
    ...
    attrs: {
      "type": "text",
      "id": "character-list-filter",
      "placeholder": "Filter character by any data"
    },
    domProps: {
    ...
    staticClass: "character-list-buttons"
  }, [_c('router-link', {
    attrs: {
      "active-class": "nav-active-button",
      "tag": "button",
      "to": {
        path: 'stats'
      }
  ...
  }), _vm._v(" Stats")]), _vm._v(" "), _c('router-link', {
    attrs: {
      "active-class": "nav-active-button",
      "tag": "button",
      "to": {
    ...
    staticClass: "fa fa-bar-chart fa-lg",
    attrs: {
      "aria-hidden": "true"
    }
  }), _vm._v(" Rankings")]), _vm._v(" "), _vm._m(1)], 1)]), _vm._v(" "), _c('character-table', {
    attrs: {
      "sort-col": _vm.sortCol,
      "sort-desc": _vm.sortDesc,
      "update": true,
      "headers": _vm.view.headers,
      "columns": _vm.view.columns,
      "characters": _vm.filteredMembers
    },
    on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-bd81c8ce", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('table', {
    staticClass: "character-list-table"
  ...
  }), _vm._v(" "), _c('thead', [_c('tr', {
    staticClass: "table-overhead"
  }, [_vm._l((_vm.headers), function(header) {
    return _c('th', {
      attrs: {
        "colspan": header.cols
    ...
    return _c('th', {
      ...
      staticClass: "fa fa-sort-asc sort-icon-asc",
      class: {
        'sort-active': (col.id == _vm.sortCol) && !_vm.sortDesc
      },
      attrs: {
        "aria-hidden": "true"
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "fa fa-sort-desc sort-icon-desc",
      class: {
        'sort-active': (col.id == _vm.sortCol) && _vm.sortDesc
      },
      attrs: {
  ...
  }, [_vm._v("Updated")]) : _vm._e()], 2)]), _vm._v(" "), _c('tbody', [_vm._l((_vm.characters), function(char) {
    return _c('tr', {
      class: {
        'update-table-item-success': char.update.updated
      }
    }, [_vm._l((_vm.columns), function(col) {
      return _c('td', {
        class: [col.applyClass ? _vm.slugify(char[col.class_name]) : '', (col.id == _vm.sortCol) ? 'sort-active-column' : '']
      }, [_vm._v(_vm._s(_vm.getPropByString(char, col.id)))])
    }), _vm._v(" "), (_vm.update) ? [_c('td', [_vm._v(_vm._s(_vm.updatedAt(char)))]), _vm._v(" "), _c('td', [_c('button', {
      staticClass: "list-button",
      attrs: {
        "disabled": _vm.disableUpdate(char)
      },
      on: {
        "click": function($event) {
          _vm.updateCharacter(char)
        }
      }
    }, [_c('i', {
      staticClass: "fa fa-refresh fa-lg",
      class: {
        'fa-spin': char.update.updating
      },
      attrs: {
        "title": "Update Character"
      }
    })])])] : _vm._e()], 2)
  }), _vm._v(" "), (_vm.characters.length == 0) ? _c('tr', [_c('td', {
    attrs: {
      "colspan": _vm.columns.length
    }
  }, [_vm._v("No Characters Found.")])]) : _vm._e()], 2)], 2)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-c60a87c4", module.exports)
  }
}
