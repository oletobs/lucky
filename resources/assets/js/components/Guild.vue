    ...
    <div v-if="!hidden">
        <div class="character-list-input">
            <div class="character-list-buttons">
                <a type="button" href="/#/"><i class="fa fa-home fa-lg" aria-hidden="true"></i></a>
            </div>
        ...
        <character-table v-on:update="updateCharacter"
                         ...
                         :characters="filteredMembers"></character-table>
    </div>
</template>
                ...
                views: {
                    stats: {
                        ...
                        columns: [
                            ...
                            { id:'stats.equipped_ilvl', name:'Eq ilvl' },
                            { id:'stats.average_ilvl', name:'Avg ilvl' },
                            { id:'stats.artifact_ilvl', name:'Art ilvl' },
